...
/**
 * Created by zwq on 2016/3/21 11:39.<br/><br/>
 */
...
//    Toast.LENGTH_LONG（3.5秒）和 Toast.LENGTH_SHORT（2秒）
     ...
     * @param context
     * @param animResId @style/customToastAnim <br/>
     *  <style name="customToastAnim"> <br/>
     *  <item name="android:windowEnterAnimation">@anim/toast_enter</item> <br/>
     *  <item name="android:windowExitAnimation">@anim/toast_exit</item> <br/>
     *  </style> <br/>
     */
